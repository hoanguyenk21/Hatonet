<template>
  <section>
    <div class="row">
      <div class="mb-3">
          <nuxt-link class="btn btn-dark btn-block" to="/admin/page">Quay lại</nuxt-link>       
      </div>
      ...
      <div class="col-12 col-md-4 col-xl-4">
        <div class="card">
          <div class="card-body p-3">
            <div class="mb-3">
              <button class="btn btn-dark btn-block" @click="editPage()">
                Sửa bài viết
              </button>
            </div>
           <div class="mb-3">
...
export default {
  ...
  async fetch({store,route}) {
    try {
      await store.dispatch('page/getPageId',{id: route.query.id});
  ...
  methods: {
    async editPage() {
      try {
        ...
        await this.$store.dispatch('page/updatePage', formData,{root:true} );
